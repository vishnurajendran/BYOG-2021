...
namespace Scripts.FPSController
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [HideInInspector] public bool m_isSprintingVal = false;
        [HideInInspector] public bool m_noSprinting = false;
        ...
        private void Update()
        {
            ...
            if (!m_IsWalking && forward && !m_noSprinting)
            {
                m_isSprintingVal = true;
                m_Speed = m_RunSpeed;
