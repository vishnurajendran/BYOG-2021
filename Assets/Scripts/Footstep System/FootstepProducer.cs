...
namespace Scripts.FootstepsSystem
{
    ...
    public class FootstepProducer : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            else if (!FindObjectOfType<SurfaceIdentifier>()) errorMessage = "Please create a Footstep Database, otherwise footsteps cannot be played, you can create a database" +
        ...
        void PlayLandSound()
        {
            audioSource.PlayOneShot(SurfaceIdentifier.singleton.GetFootstep(currentGroundInfo.collider, currentGroundInfo.point));
        }
        ...
        void PlayFootstep()
        {
            AudioClip randomFootstep = SurfaceIdentifier.singleton.GetFootstep(currentGroundInfo.collider, currentGroundInfo.point);
