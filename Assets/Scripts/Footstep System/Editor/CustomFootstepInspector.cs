...
namespace Scripts.FootstepsSystem
{
    ...
    [CustomPropertyDrawer(typeof(RegisteredMaterial1))]
    public class MaterialsDrawer : PropertyDrawer
    {

        SurfaceIdentifier surfManag = null;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            if (!surfManag)
            {
                surfManag = GameObject.FindObjectOfType<SurfaceIdentifier>();
